...
It is used to get the hash of the [Prisma Rust Engines](https://github.com/prisma/prisma-engines) for downloading via the [Prisma CLI, the Client](https://github.com/prisma/orm), and other tooling.
...
This `engines-version` GitHub Actions workflow informs other repositories (e.g. [`prisma/orm`](https://github.com/prisma/orm) and [`prisma/prisma-engines`](https://github.com/prisma/prisma-engines)) of these published npm packages.
